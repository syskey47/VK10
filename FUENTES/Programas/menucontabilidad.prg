...
DEFINE BAR 05 OF Contabilidad PROMPT 'Presentación preliminar' ;
	SKIP FOR ! (oAplicacion.nForms > 0 AND _SCREEN.ACTIVEFORM.lPuedeImprimir AND ;
	! oAplicacion.lControlAccesos)
DEFINE BAR 06 OF Contabilidad PROMPT 'Parámetros de impresión'
...
DEFINE BAR 15 OF Contabilidad PROMPT 'Muestra barra de navegación' ;
...
DEFINE BAR 03 OF ArchivosBase PROMPT 'Catálogo de cuentas' PICTURE '..\..\imagenes\ico\catalog.ico'
DEFINE BAR 04 OF ArchivosBase PROMPT 'Categorías de cuentas'
DEFINE BAR 05 OF ArchivosBase PROMPT '\-'
DEFINE BAR 06 OF ArchivosBase PROMPT 'Categorías de deudores'
DEFINE BAR 10 OF ArchivosBase PROMPT '\-'
DEFINE BAR 11 OF ArchivosBase PROMPT 'Analítica' INVERT
...
DEFINE BAR 01 OF Analitica PROMPT 'Planes analíticos'
DEFINE BAR 02 OF Analitica PROMPT 'Estructuras analíticas'
...
*DEFINE BAR 06 OF Otros PROMPT '\Códigos de IVA'
*DEFINE BAR 07 OF Otros PROMPT '\Condiciones de pago'
*DEFINE BAR 08 OF Otros PROMPT '\Códigos de idiomas'
*DEFINE BAR 09 OF Otros PROMPT '\Códigos postales'
...
DEFINE BAR 02 OF Entradas PROMPT 'Entradas de diario otros módulos'
...
DEFINE BAR 11 OF Entradas PROMPT 'Cierre de año' INVERT
...
ON BAR 11 OF Entradas ACTIVATE POPUP CierreAño

DEFINE POPUP CierreAño MARGIN RELATIVE SHADOW COLOR SCHEME 4
DEFINE BAR 01 OF CierreAño PROMPT 'Cierre cuentas de resultado'
DEFINE BAR 02 OF CierreAño PROMPT 'Reclasificación de nits. por cuenta'
*!*	DEFINE BAR 2 OF CierreAño PROMPT '\Reapertura automática'
*!*	DEFINE BAR 3 OF CierreAño PROMPT '\Anular la reapertura'
*!*	DEFINE BAR 4 OF CierreAño PROMPT '\Cierre definitivo'

ON SELECTION BAR 01 OF CierreAño oAplicacion.EjecutaFormularioRetorno('CONTABILIDAD', .T., 'frm_CTB_CierreCuentasDeResultado')
ON SELECTION BAR 02 OF CierreAño oAplicacion.EjecutaFormularioRetorno('CONTABILIDAD', .T., 'frm_CTB_ReclasificacionNitsPorCuenta')
...
DEFINE BAR 16 OF Reportes PROMPT 'Informes analíticos' INVERT PICTURE '..\..\imagenes\bmp\smAppFiles.gif'
...
DEFINE BAR 01 OF Cuentas PROMPT 'Catálogo de cuentas'
DEFINE BAR 02 OF Cuentas PROMPT 'Cuentas por categoría'
DEFINE BAR 03 OF Cuentas PROMPT 'Catálogo por cuenta alterna'
...
DEFINE BAR 01 OF InformesAnaliticos PROMPT 'Comprobantes de diario por fecha con información analítica'
DEFINE BAR 02 OF InformesAnaliticos PROMPT 'Movimientos por cuenta con información analítica'
*!*	DEFINE BAR 03 OF InformesAnaliticos PROMPT '\Movimientos por documento con información analítica'
*!*	DEFINE BAR 04 OF InformesAnaliticos PROMPT '\Movimientos por nit. con información analítica'
*!*	DEFINE BAR 05 OF InformesAnaliticos PROMPT '\-'
*!*	DEFINE BAR 06 OF InformesAnaliticos PROMPT '\Balance de prueba con información analítica'
*!*	DEFINE BAR 07 OF InformesAnaliticos PROMPT '\Balances general con información analítica'
*!*	DEFINE BAR 08 OF InformesAnaliticos PROMPT '\-'
*!*	DEFINE BAR 09 OF InformesAnaliticos PROMPT '\Estado de resultados con información analítica'
...
DEFINE BAR 06 OF DocumentosOficiales PROMPT 'Certificados de retención fuente'
DEFINE BAR 07 OF DocumentosOficiales PROMPT 'Certificados de retención industria y comercio'
DEFINE BAR 08 OF DocumentosOficiales PROMPT '\-'
DEFINE BAR 09 OF DocumentosOficiales PROMPT 'Numeración de libros'
